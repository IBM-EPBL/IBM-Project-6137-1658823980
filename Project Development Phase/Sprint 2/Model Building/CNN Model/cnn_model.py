...
Original file is located at
    https://colab.research.google.com/drive/1x9ARS0Bmowybdxn3EamZ5GQqCU0XfF6x
"""
...
model = classifier.fit_generator(training_set,steps_per_epoch=100,epochs=100,validation_data = test_set,validation_steps = 6500)
